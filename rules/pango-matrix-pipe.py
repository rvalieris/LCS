...
rule repo:
	output: PANGO_DESIGNATIONS, PANGO_DESIGNATIONS_DIR
	shell: 'git clone --depth 1 --brach {PANGO_DESIGNATIONS_VERSION} {PANGO_DESIGNATIONS_REPO} {PANGO_DESIGNATIONS_DIR}'
